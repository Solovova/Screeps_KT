...
fun MainRoom.marketCreateBuyOrders() {
    ...
    if (Game.market.credits < mc.constants.globalConstant.marketMinCreditForOpenBuyOrder) return

    val priceEnergy = mc.constants.globalConstant.marketBuyPriceEnergy
